...
module.exports = {
  ...
  settings: {
    requiredPrivileges: {
      create: ['superadmin', 'admin', 'writter', 'writer-uploader'],
      getProxy: ['superadmin', 'admin', 'writter', 'writer-uploader'],
      listProxy: ['superadmin', 'admin', 'writter', 'writer-uploader'],
      removeProxy: ['superadmin', 'admin', 'writter', 'writer-uploader'],
    },
